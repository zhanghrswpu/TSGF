...
'''
parser = argparse.ArgumentParser(description='Generate Adversary Examples')
parser.add_argument('--n_imgs', type=int, default=20)
parser.add_argument('--batch_size', type=int, default=16)
parser.add_argument('--model_dir', type=str, default='./checkpoints/TSGF/models', help="Path from where to load trained substitute model dir")
parser.add_argument('--model_pth', type=str, default='FDACL_100.pth', help="Path from where to load trained substitute model file")
parser.add_argument('--data_dir', type=str, default='./data/ILSVRC2012_img_val', help="Path to ImageNet-validation dir")
...
if __name__ == '__main__':
    ...
    msfaa = torchattacks.MSFAAttack(model, pretrained=False, eps=args.eps_test/255, alpha=1/255, steps=300, mu=1.0)
